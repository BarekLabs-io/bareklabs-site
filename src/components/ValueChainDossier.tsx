  ...
  return (
    <div className="border border-line bg-panel">
      <div className="border-b border-line px-6 py-4">
        ...
        <p className="mt-2 max-w-7xl font-mono-lab text-[13px] leading-6 tracking-wide text-dim">{d.intro}</p>
      </div>
      ...
      <div className="p-6">
          ...
          <div className="flex flex-col gap-4">
            {LAYERS.map((l) => (
              <div key={l.n} className="border border-line bg-card2 p-5" style={{ borderInlineStartWidth: 3, borderInlineStartColor: l.accent }}>
                ...
                {l.note && <p className="mt-2 max-w-7xl font-mono-lab text-[11.5px] leading-6 tracking-wide text-dim">{l.note}</p>}
                <div className="mt-4 flex flex-col gap-4">
                  {l.segments.map((sg) => (
                    <div key={sg.name} className="border-t border-line pt-3">
                      ...
                      <p className="mt-1.5 max-w-6xl font-mono-lab text-[11.5px] leading-6 tracking-wide text-dim">{sg.role}</p>
        ...
        {tab === 'epc' && (
          <div>
            <p className="max-w-7xl font-mono-lab text-[13px] leading-6 tracking-wide text-dim">{d.epcIntro}</p>
