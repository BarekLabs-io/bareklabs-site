...
export const en = {
  ...
  insights: {
    ...
    filters: [
      'ALL', 'MACRO', 'STRUCTURE', 'FLOWS', 'CRYPTO',
      'BANKS & FINANCE', 'TELECOM & TECH', 'ENERGY & SPACE', 'HEALTH & CONSUMER',
      'CONSTRUCTION & MATERIALS', 'REAL ESTATE', 'INDUSTRIALS', 'UTILITIES',
    ],
    notes: [
  ...
  souk: {
    ...
    methodNote: 'THE WHOLE REGIONAL MARKET, NOT ONE COMPANY — A WEIGHTED BLEND OF THE SIX COMPONENTS BELOW. BREADTH AND FOREIGN FLOW WEIGHTED HIGHEST, ANOMALY FLAGS AS A PENALTY. NOT A BLACK BOX.',
    read: {
      title1: "Today's read:",
    ...
    components: {
      ...
      rows: [
        { k: 'BREADTH (ADV/DEC)', what: 'Advancing stocks vs. declining stocks, region-wide.', v: '1.42', tone: 'up', note: 'Expanding for 3rd session' },
        { k: 'TURNOVER VELOCITY', what: 'How fast money is rotating through the market vs. normal.', v: '0.87', tone: 'mid', note: 'Compressing — energy building' },
        { k: 'FOREIGN NET FLOW', what: 'Net money moving in vs. out from foreign investors.', v: '+18.2M', tone: 'up', note: 'Largest print in 6 weeks' },
        { k: 'VOLATILITY REGIME', what: 'How choppy price swings are right now.', v: 'LOW', tone: 'mid', note: 'Compression precedes expansion' },
        { k: 'SECTOR LEADERSHIP', what: 'Which sector is driving the market\'s direction.', v: 'BANKS', tone: 'up', note: 'Rotation confirmed by breadth' },
        { k: 'ANOMALY SCAN', what: 'Unusual trading patterns flagged for review.', v: '2 FLAGS', tone: 'down', note: 'Volume outliers under review' },
      ],
    },
    watchlist: {
      head: 'On the radar',
