...
export const en = {
  ...
  souk: {
    ...
    watchlist: {
      ...
      legend: [
        { k: 'STRONG', d: 'The setup has already triggered with confirming volume — our highest-conviction reads.', tone: 'up' },
        { k: 'BUILDING', d: 'The setup is forming but hasn\'t triggered yet — worth watching, not yet worth chasing.', tone: 'up' },
        { k: 'CAUTION', d: 'Technical structure is deteriorating — we\'d reduce exposure or avoid adding here.', tone: 'down' },
        { k: 'NEUTRAL', d: 'No clear edge either way yet — no action implied until the trigger price is reached.', tone: 'mid' },
      ],
    },
  },
  tracker: {
