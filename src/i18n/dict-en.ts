...
export const en = {
  ...
  about: {
    ...
    story: {
      ...
      paragraphs: [
        "I started BAREK LABS almost by accident. During COVID, my employer let me work remotely, so I moved back from Sweden to stay with my parents in France — I kept the same job the whole time, but the workload slowed to a crawl, and for the first time in years I had real free time. I filled most of it reading: about companies, about markets, about finance in general. I'd always invested and always been curious about the space, but that period is where the curiosity turned into a habit.",
