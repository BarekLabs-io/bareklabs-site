...
export const en = {
  ...
  tracker: {
    ...
    ledgers: {
      ...
      stocks: {
        code: '03.A',
        name: 'STOCKS',
        desc: 'Regional equity positions. Last price comes from the quote feed; the record itself does not move. Each entry tied to a published thesis.',
  ...
  stocks: {
    hero: {
      ...
      title: 'Stocks',
      serif: 'ledger',
      desc: "EQUITY POSITIONS AS THEY ARE TAKEN. LAST PRICE COMES FROM THE QUOTE FEED; THE RECORD ITSELF DOES NOT MOVE. EVERY ENTRY LINKED TO A PUBLISHED THESIS.",
    },
    head: 'Positions',
    ...
    weightNote: 'Weight carries a dash on every line. It is only meaningful across the combined book of both brokers, and the ratio between the two books is not published — the size of the book is the one number this ledger does not disclose. A weight internal to a single account would be wrong standing next to a line from the other.',
