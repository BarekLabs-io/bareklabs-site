...
export const en = {
  ...
  stocks: {
    ...
    sourceNote: 'POSITIONS COME FROM TWO OF THE LAB’S BROKERAGE ACCOUNTS — IBKR AND NORDNET — AND EVERY LINE CARRIES ITS OWN. ENTRY PRICES AND DATES ARE THE BROKERS’ NUMBERS; LAST PRICE AND P&L ON OPEN POSITIONS ARE RECOMPUTED LIVE FROM THE QUOTE FEED. CLOSED RESULTS ARE SHOWN IN THE TRADE’S OWN CURRENCY, WITH THE SEK READING NET OF FEES BESIDE IT.',
    historyNote: 'Record predating the opening of the ledger (2026.08.07), reconstructed from the brokerage statements.',
    weightNote: 'Weights over invested positions, cash excluded, as of 2026.09.18. They span the combined book of both brokers, so a line reads against the whole ledger rather than against its own account.',
