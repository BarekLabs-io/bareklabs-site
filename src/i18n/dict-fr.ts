...
export const fr: Dict = {
  ...
  souk: {
    ...
    components: {
      ...
      rows: [
        { k: 'LARGEUR (ADV/DEC)', v: '1.42', tone: 'up', note: 'En expansion pour la 3e séance' },
        { k: 'VÉLOCITÉ DES VOLUMES', v: '0.87', tone: 'mid', note: 'Compression — l’énergie s’accumule' },
        { k: 'FLUX NET ÉTRANGER', v: '+18.2M', tone: 'up', note: 'Plus gros chiffre en 6 semaines' },
        { k: 'RÉGIME DE VOLATILITÉ', v: 'BAS', tone: 'mid', note: 'La compression précède l’expansion' },
        { k: 'LEADERSHIP SECTORIEL', v: 'BANQUES', tone: 'up', note: 'Rotation confirmée par la largeur' },
        { k: 'SCAN D’ANOMALIES', v: '2 ALERTES', tone: 'down', note: 'Volumes aberrants sous revue' },
      ],
    },
    watchlist: {
      head: 'Au radar',
