...
export const fr: Dict = {
  ...
  insights: {
    ...
    filters: [
      'TOUT', 'MACRO', 'STRUCTURE', 'FLUX', 'CRYPTO',
      'BANQUES & FINANCE', 'TÉLÉCOMS & TECH', 'ÉNERGIE & ESPACE', 'SANTÉ & CONSOMMATION',
      'CONSTRUCTION & MATÉRIAUX', 'IMMOBILIER', 'INDUSTRIE', 'SERVICES PUBLICS',
    ],
    notes: [
      ...
      { d: '2026.07.22', tag: 'CRYPTO', t: 'La vélocité des stablecoins comme indicateur avancé des rotations risk-on', read: '11', conf: 69 },
      { d: '2026.07.18', tag: 'STRUCTURE', t: 'L’enchère de clôture dit la vérité : guide de terrain des déséquilibres d’ordres', read: '8', conf: 90 },
      { d: '2026.07.14', tag: 'MACRO', t: 'Divergence des trajectoires de taux et son effet sur les valorisations small-cap', read: '10', conf: 77 },
  ...
  souk: {
    ...
    methodNote: 'L’ENSEMBLE DU MARCHÉ RÉGIONAL, PAS UNE SEULE ENTREPRISE — MOYENNE PONDÉRÉE DES SIX COMPOSANTES CI-DESSOUS. LARGEUR ET FLUX ÉTRANGER PÈSENT LE PLUS, LES ALERTES D’ANOMALIE EN PÉNALITÉ. PAS UNE BOÎTE NOIRE.',
    read: {
    ...
    components: {
      ...
      rows: [
        { k: 'LARGEUR (ADV/DEC)', what: 'Valeurs en hausse contre valeurs en baisse, sur toute la région.', v: '1.42', tone: 'up', note: 'En expansion pour la 3e séance' },
        { k: 'VÉLOCITÉ DES VOLUMES', what: 'La vitesse de rotation de l’argent sur le marché, par rapport à la normale.', v: '0.87', tone: 'mid', note: 'Compression — l’énergie s’accumule' },
        { k: 'FLUX NET ÉTRANGER', what: 'Argent net entrant ou sortant des investisseurs étrangers.', v: '+18.2M', tone: 'up', note: 'Plus gros chiffre en 6 semaines' },
        { k: 'RÉGIME DE VOLATILITÉ', what: 'À quel point les prix bougent de façon erratique en ce moment.', v: 'BAS', tone: 'mid', note: 'La compression précède l’expansion' },
        { k: 'LEADERSHIP SECTORIEL', what: 'Quel secteur mène la direction du marché.', v: 'BANQUES', tone: 'up', note: 'Rotation confirmée par la largeur' },
        { k: 'SCAN D’ANOMALIES', what: 'Comportements de trading inhabituels signalés pour revue.', v: '2 ALERTES', tone: 'down', note: 'Volumes aberrants sous revue' },
      ],
    },
    watchlist: {
      head: 'Au radar',
      refresh: 'ACTUALISÉ',
      cols: { ticker: 'TICKER', setup: 'CONFIGURATION', trigger: 'DÉCLENCHEUR', signal: 'SIGNAL' },
      rows: [
        { t: 'ATW', s: 'Retest de cassure', g: 'Tenir au-dessus de 405', sig: 'FORT', up: true },
        { t: 'LBV', s: 'Formation de base', g: 'Expansion de volume', sig: 'EN CONSTRUCTION', up: true },
        { t: 'CSRH', s: 'Risque de distribution', g: 'Perdre le support 116', sig: 'PRUDENCE', up: false },
        { t: 'IAM', s: 'Compression de range', g: 'Casser le pivot 132', sig: 'NEUTRE', up: true },
      ],
    },
  },
  tracker: {
